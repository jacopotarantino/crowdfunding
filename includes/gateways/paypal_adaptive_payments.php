 ...
 * @return void
 */
function atcf_collect_funds_paypal_adaptive_payment( $gateway, $gateway_args, $campaign, $errors ) {
	global $errors;
...
add_action( 'atcf_collect_funds_paypal_adaptive_payment', 'atcf_collect_funds_paypal_adaptive_payment', 10, 4 );